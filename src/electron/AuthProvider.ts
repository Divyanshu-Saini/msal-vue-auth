...
export default class AuthProvider {
  ...
  async getTokenSilent(
    authWindow: BrowserWindow,
    tokenRequest: SilentFlowRequest | any
  ...
  async getTokenInteractive(
    authWindow: BrowserWindow,
    tokenRequest: AuthorizationUrlRequest | any
  ): Promise<AuthenticationResult> {
  ...
  async login(authWindow: BrowserWindow): Promise<AccountInfo> {
    console.info("IN Login block :", this.authCodeUrlParams);
    const authResult = await this.getTokenInteractive(
      authWindow,
      this.authCodeUrlParams
    );
    console.info("After Login :", authResult);
